...
export class SettingsController {
    public async getTopOffers(): Promise<{}[]> {
        return MHApi.request('GET', 'settings/topoffers');
    }

    public async getHardware(): Promise<{}[]> {
        return MHApi.request('GET', 'settings/hardware');
    }

    public async getImprint(): Promise<string> {
        return MHApi.request('GET', 'settings/imprint');
    }

    public async getAGB(): Promise<string> {
        return MHApi.request('GET', 'settings/agb');
    }

    public async getPrivacy(): Promise<string> {
        return MHApi.request('GET', 'settings/privacy');
    }

    public async getRightOfWithdrawalid(): Promise<string> {
        return MHApi.request('GET', 'settings/rightofwithdrawalid');
    }

    public async getPaymentAndShipping(): Promise<string> {
        return MHApi.request('GET', 'settings/paymentandshipping');
    }

    public async getMaintenance(): Promise<{ maintenance: boolean }> {
        return MHApi.request('GET', 'settings/maintenance');
    }
    ...
    public async setMaintenance(): Promise<{ maintenance: boolean }> {
        return MHApi.request('POST', 'settings/maintenance');
    }
}
